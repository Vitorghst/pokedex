    ...
    >
      <PokemonHeaderInfo>
        ...
        >
          ...
          <PokemonName textColor={pokemonInfo.tipoPrincipal.cor}>{pokemonInfo.renderName}</PokemonName>
        </View>
        <PokemonID textColor={pokemonInfo.tipoPrincipal.cor}>#{pokemonInfo.id}</PokemonID>
      </PokemonHeaderInfo>
